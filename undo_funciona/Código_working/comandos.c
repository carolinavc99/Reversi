...
/*
    ...
    na função undo do menu.c, mandei verificar se já estava no estado inicial em vez de o fazer aqui
 */
...
int novaJogada (ESTADO e, int linha, int coluna, int jogadas_efetuadas) {
