...
ESTADO menu (ESTADO e, struct JOGADA* topo) { // interpretador
    ...
    char input[1024];
    ESTADO v;
    // Esta variável controla se é o bot a começar o jogo, ou se deve esperar que o jogador jogue primeiro
    int controlo=0;
            ...
            case 'A':
                ...
                if(arg1 != 'X' && arg1 != 'O') printf("Peça inválida");
                    ...
                    if(arg2 != '1' && arg2 != '2' && arg2 != '3') printf("Dificuldade inválida");
                        ...
                        // Verificar se começa a jogar:

                        // Caso seja o Bot a começar o jogo, aumenta
                        // controlo (para indicar que o bot chegou logo à sua vez de jogar)
                        if (arg1=='X') controlo = 1;

                        if (controlo == 1) {
                            printf("\n\n#### Jogada do Bot ####\n");  // ;;;RETIREI O SWITCH QUE NÃO ESTAVA A FAZER NADA AQUI;;;
                            e = bot(e);
                        }
                        // Caso não seja o Bot a começar, aumenta o 'controlo' e passa a jogada ao jogador
                        controlo = 1;
                    }
                }
                break;
