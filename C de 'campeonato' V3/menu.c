            ...
            */
            ...
            case 'D':
                printf("\n======================================================================================================="
                       ...
                       "\n| C <ficheiro>     || Cria um novo tabuleiro para jogar contra outro grupo se não existir já um.      |"
                       "\n|                       Caso exista, lê o ficheiro e faz a jogada para voltar a devolver ao grupo     |"
                       "\n|                         adversário.                                                                 |"
                       "\n| Q                || Sair do jogo.                                                                   |"
                       "\n======================================================================================================="
                       "\n");
